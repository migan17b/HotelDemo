...
import pe.com.socialdata.hotel.rc.client.LoginIn;
import pe.com.socialdata.hotel.rc.client.TokenOut;
...
import pe.com.socialdata.hotel.service.impl.UserServiceImpl;
...
public class RestAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	protected final UserDetails retrieveUser(String username,
		...
		UserDetails loadedUser;
		 ...
		 BackendRestInvoker<TokenOut> restInvoker= new BackendRestInvoker<TokenOut>(ConstantesURL.SECURITY_SERVER,ConstantesURL.SECURITY_PORT);
			
		  LoginIn in =new LoginIn(username,password);
		
		  ResponseEntity<TokenOut> responseEntity=
				restInvoker.sendPost(ConstantesURL.SECURITY_CONTEXT +"/login", in, TokenOut.class);
		
		  TokenOut token = responseEntity.getBody();

		 System.out.println("token: "+ token.getToken());
		 
		 
		try {
			UserServiceImpl userService  = (UserServiceImpl) this.getUserDetailsService();
			userService.setToken(token.getToken());
