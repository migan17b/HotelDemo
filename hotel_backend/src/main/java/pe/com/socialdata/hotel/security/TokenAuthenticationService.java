...
public class TokenAuthenticationService {
	...
	private static final String PUBLIC_KEY_FILE_RSA_BLOCKCHAIN = "/security/rsa-public.pem";  
    ...
    static Authentication getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
        	...
        	try {
				key = (RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA_BLOCKCHAIN, "RSA");
